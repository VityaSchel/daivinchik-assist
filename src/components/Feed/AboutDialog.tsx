          ...
          <ScrollView contentContainerStyle={{ paddingVertical: 18 }}>
            <Dialog.Content>
              <Paragraph>
                ...
                базу данных. Если у тебя меньше 100 000 сообщений, то беспокоиться не о чем. В
                противном случае, помни, что эти данные сохранятся в кеш приложения, который ты 
                сможешь почистить через настройки своего устройства.
              </Paragraph>
              <Paragraph>
